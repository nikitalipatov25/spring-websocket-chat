...
public class SocketIOController {
    ...
    private SocketIOServer socketServer;
     ...
     private SocketIOController(SocketIOServer socketServer){
    ...
    public ConnectListener onUserConnectWithSocket = client -> log.info("Perform operation on user connect in controller");
